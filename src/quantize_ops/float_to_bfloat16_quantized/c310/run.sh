...
# 3. 参数配置
# ==============================================================================
vendor_name="float_to_bfloat16_quantized"
export AI_CORE_PROFILE="c310"
export OPERATOR_JSON_FILE="$(readlink -f "${WORK_DIR}/float_to_bfloat16_quantized.json")"
export OPERATOR_SOURCE_ROOT="$(readlink -f "${WORK_DIR}")"
export INSERT_SUPPORT_950_PATHS="op_host/float_to_bfloat16_quantized.cpp"
