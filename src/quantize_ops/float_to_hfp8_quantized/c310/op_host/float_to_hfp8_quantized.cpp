...
// clang-format off
#include "float_to_hfp8_quantized_tiling.h"
...
namespace ops
{
class FloatToHfp8Quantized : public OpDef
{
   public:
    explicit FloatToHfp8Quantized(const char* name) : OpDef(name)
    {
        this->Input("input")
            .ParamType(REQUIRED)
        ...
        this->Attr("max_pos").AttrType(REQUIRED).Float();
