...
# 3. 参数配置
# ==============================================================================
vendor_name="fused8_bit_rowwise_quantized_to_float_or_half"
export AI_CORE_PROFILE="c310"
export OPERATOR_JSON_FILE="$(readlink -f "${WORK_DIR}/fused8_bit_rowwise_quantized_to_float_or_half.json")"
export OPERATOR_SOURCE_ROOT="$(readlink -f "${WORK_DIR}")"
export INSERT_SUPPORT_950_PATHS="op_host/fused8_bit_rowwise_quantized_to_float_or_half.cpp"
