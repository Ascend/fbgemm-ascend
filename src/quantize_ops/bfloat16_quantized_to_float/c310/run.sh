...
# 3. 参数配置
# ==============================================================================
vendor_name="bfloat16_quantized_to_float"
export AI_CORE_PROFILE="c310"
export OPERATOR_JSON_FILE="$(readlink -f "${WORK_DIR}/bfloat16_quantized_to_float.json")"
export OPERATOR_SOURCE_ROOT="$(readlink -f "${WORK_DIR}")"
export INSERT_SUPPORT_950_PATHS="op_host/bfloat16_quantized_to_float.cpp"
