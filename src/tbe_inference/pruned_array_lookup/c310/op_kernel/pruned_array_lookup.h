...
__simt_vf__ __launch_bounds__(SIMT_THREAD_NUM)
    inline void PrunedArrayLookupSimtMultiBatch(
        const __gm__ DataType* indices,
        const __gm__ DataType* offsets,
        const __gm__ ArrayType* indexRemappings,
        const __gm__ int64_t* indexRemappingsOffset,
