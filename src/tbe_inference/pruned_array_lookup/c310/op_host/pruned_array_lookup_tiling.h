...
#ifndef PRUNED_ARRAY_LOOKUP_TILING
#define PRUNED_ARRAY_LOOKUP_TILING
#include "register/tilingdata_base.h"

namespace optiling {
    BEGIN_TILING_DATA_DEF(PrunedArrayLookupTilingData)
    ...
    TILING_DATA_FIELD_DEF(int64_t, indexRemappingsLen);
    TILING_DATA_FIELD_DEF(int64_t, indexRemappingsOffsetsLen);

    END_TILING_DATA_DEF;

    REGISTER_TILING_DATA_CLASS(PrunedArrayLookup, PrunedArrayLookupTilingData)
}  // namespace optiling
#endif
