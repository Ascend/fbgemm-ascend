...
| src/jagged_tensor_ops/jagged_dense_dense_elementwise_add_jagged_output                     | [README](../src/jagged_tensor_ops/jagged_dense_dense_elementwise_add_jagged_output/README.md)                     | 将jagged tensor与两个dense tensor进行逐元素加法，最终输出jagged tensor                                                                  | A5 |
...
| src/jagged_tensor_ops/stacked_jagged_1d_to_dense                           | [README](../src/jagged_tensor_ops/stacked_jagged_1d_to_dense/README.md)                           | 将1D jagged tensor，按key，切成T段，分别转为padded dense tensor。                                                                                                   | A5 |
| src/jagged_tensor_ops/stacked_jagged_2d_to_dense                           | [README](../src/jagged_tensor_ops/stacked_jagged_2d_to_dense/README.md)                           | 将2D jagged tensor，按key，切成T段，分别转为padded dense tensor。                                                                                                   | A5 |
