...
| src/jagged_tensor_ops/jagged_to_padded_dense_v2 | 无                                                                                              | 将jagged tensor转为padded dense tensor的v2版本，优化了性能和内存占用。 | A2, A3, A5 |
...
| src/sparse_ops/expand_into_jagged_permute | [README](../src/sparse_ops/expand_into_jagged_permute/README.md)                               | 用于把将稀疏数据置换索引从表维度扩展到批次维度。 | A5 |
